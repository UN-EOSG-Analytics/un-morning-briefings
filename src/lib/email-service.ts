...
export async function sendPasswordResetEmail(
  ...
  const mailOptions = {
    from: process.env.SMTP_FROM,
    to: email,
    subject: "Reset your password - UN Morning Briefing System",
    html: `
      <!DOCTYPE html>
      <html>
        <head>
                ...
                <table width="100%" style="max-width:520px;">
                  ...
                  <tr>
                    <td>
                      ...
                      <a href="${resetUrl}" style="display:inline-block;background:#009edb;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:6px;font-size:14px;font-weight:500;border:none;cursor:pointer;">Reset Password</a>
                      <p style="margin:24px 0 0;font-size:13px;line-height:1.5;color:#9ca3af;">If the button doesn't work, copy and paste this link into your browser:<br><a href="${resetUrl}" style="color:#009edb;word-break:break-all;text-decoration:none;">${resetUrl}</a></p>
                    </td>
                  </tr>
                  <!-- Security Notice -->
                  <tr>
                    <td style="padding:24px 0 0;border-top:1px solid #e5e7eb;margin-top:24px;">
