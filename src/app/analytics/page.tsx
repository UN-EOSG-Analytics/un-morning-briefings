...
export default function AnalyticsPage() {
  ...
  const startDate = getDateFromSlider(
    Math.floor((dateRange[0] / 100) * allAvailableDates.length),
  );
  const endDate = getDateFromSlider(
    Math.floor((dateRange[1] / 100) * allAvailableDates.length),
  );
      ...
      if (response.ok) {
        ...
        if (allAvailableDates.length === 0) {
          const uniqueDates = Array.from(
            new Set(
              data.chronologicalData?.map((item: any) => item.date) || [],
            ),
          ).sort() as string[];
  ...
  const regionalData =
    analyticsData?.regionalDistribution?.map((item) => ({
      name: item.region,
  ...
  const entryLengthData =
    analyticsData?.entryLengthDistribution?.map((item) => ({
  ...
  return (
    <div className="bg-background">
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        {/* Header */}
        <Card className="mb-6 border-slate-200 py-0">
        ...
        <Card className="mb-6 py-4">
          <CardHeader>
            ...
            <CardDescription>
              {labelsData.analytics.filters.description}
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Slider
                    value={dateRange}
                    onValueChange={(value) =>
                      setDateRange([value[0], value[1]] as [number, number])
                    }
                    min={0}
                    max={100}
                    step={1}
        ...
        <Card className="mb-6">
          <CardContent className="relative">
            <div className="absolute top-4 right-10 z-10 flex flex-col gap-2">
              <Button
                variant="ghost"
                size="sm"
              ...
              <div className="flex h-100 items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    {labelsData.analytics.loading.map}
                  </p>
                </div>
              </div>
            ) : (
            ...
            <div className="relative h-full w-full overflow-hidden">
              ...
              {loading ? (
                ...
                <WorldMapHeatmap
                  ...
                  connections={
                    showConnections
                      ? analyticsData?.countryConnections || []
                      : []
                  }
                  className="h-full"
                />
        ...
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="mt-4 text-sm text-slate-600">
                {labelsData.analytics.loading.data}
              </p>
            </div>
          </div>
          ...
          <>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.regionalDistribution}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.regionalDistributionDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.topRegions}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.topRegionsDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.categoryDistribution}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.categoryDistributionDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.entryLengthDistribution}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.entryLengthDistributionDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.topCountries}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.topCountriesDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.monthlyTrends}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.monthlyTrendsDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
            ...
            <div className="mt-6">
              <Card>
                <CardHeader>
                  <CardTitle>
                    {labelsData.analytics.charts.regionalActivity}
                  </CardTitle>
                  <CardDescription>
                    {labelsData.analytics.charts.regionalActivityDesc}
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="py-12 text-center">
            <p className="mb-2 text-slate-600">
              {labelsData.analytics.empty.title}
            </p>
