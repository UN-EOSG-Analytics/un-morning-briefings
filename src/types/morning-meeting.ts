...
export const CATEGORIES = [
  ...
  'Code Cable',
  'SitRep',
  'Other UN Internal Document',
];

export const PRIORITIES = [
  { value: 'sg-attention', label: "For the SG's attention" },
  { value: 'situational-awareness', label: 'Situational Awareness' },
];
...
export const COUNTRIES_BY_REGION: Record<string, string[]> = {
  ...
  'Global / Cross-Regional': ['Multiple Countries', 'Global Issue'],
};
