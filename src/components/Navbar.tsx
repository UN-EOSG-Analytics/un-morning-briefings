      ...
      <nav className="fixed top-0 right-0 left-0 z-50 border-b border-slate-200 bg-white">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            {session && (
              <span className="ml-2 hidden items-center gap-1.5 rounded-full border border-slate-300 bg-slate-100 px-2 py-1 text-xs font-semibold text-slate-700 lg:flex">
        ...
        {/* Mobile Menu Content */}
        {isOpen && session && (
          <div className="absolute top-16 right-0 left-0 border-b border-slate-200 bg-white md:hidden">
